...
/**
 * Vrai si le joueur a déjà envoyé son action pour ce tour (US-19 CA2, US-21 CA2).
 * La RLS ne laisse voir que ses propres actions : le choix de l'adversaire reste secret.
 */
export async function hasPlayedThisTurn(matchId: string, round: number, turn: number): Promise<boolean> {
