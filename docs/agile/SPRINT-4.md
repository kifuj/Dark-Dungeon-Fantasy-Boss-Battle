...
- **Après le rendu (17/09 après-midi, hors sprint, hors vélocité)** : le PO a demandé une liste d'améliorations, livrée en bonus dans le jalon `Réserve` : US-35 à US-45 (Frappe pour tous, niveau par KO, parchemin choisi, Golem, PP, boosts d'ATQ, évolutions, recrutement, clavier, revanche, équilibrage de la difficulté solo) et la musique de combat (US-25, partielle). Détail dans le [Product Backlog](PRODUCT-BACKLOG.md). Écart de DoD : PR relue par personne, estimations à rejouer en Planning Poker.
