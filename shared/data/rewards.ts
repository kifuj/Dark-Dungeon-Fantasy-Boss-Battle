...
export const REWARDS: Record<RewardId, RewardDef> = {
  ...
  recruit: { id: 'recruit', name: 'Recrutement', icon: '🐾', description: 'Le monstre vaincu rejoint l’équipe, au niveau de celle-ci.', weight: 35, minLoot: 0 },
  ...
  intensive_training: {
    ...
    description: '+1 niveau pour toute l’équipe.', weight: 12, minLoot: 2,
  },
  war_camp: {
