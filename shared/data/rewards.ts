...
export const REWARDS: Record<RewardId, RewardDef> = {
  ...
  training: { id: 'training', name: 'Entraînement', icon: '🗡️', description: '+2 niveaux pour un monstre au choix.', weight: 25, minLoot: 0 },
  recruit: { id: 'recruit', name: 'Recrutement', icon: '🐾', description: 'Le monstre vaincu rejoint l’équipe.', weight: 20, minLoot: 0 },
  scroll: { id: 'scroll', name: 'Parchemin', icon: '📜', description: 'Un monstre apprend une compétence tirée au hasard.', weight: 10, minLoot: 0 },
  royal_potion: {
  ...
  intensive_training: {
    ...
    description: '+4 niveaux pour un monstre au choix.', weight: 12, minLoot: 2,
  },
  war_camp: {
    id: 'war_camp', name: 'Camp d’entraînement', icon: '🏕️',
    description: '+2 niveaux pour toute l’équipe.', weight: 10, minLoot: 3,
  },
  relic: {
    id: 'relic', name: 'Relique du boss', icon: '👑',
    description: '+3 niveaux pour toute l’équipe, qui est entièrement soignée.', weight: 0, minLoot: 4,
  },
};
